...
//     // Testimonial slider code (keep your existing slider code)
//     // ...
// });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // (Keep your testimonial slider, scroll effects, etc.)
});


// Fix services button
document.querySelectorAll('a[href="services.html"]').forEach(button => {
    button.addEventListener('click', function(e) {
        // Ensure default navigation works
